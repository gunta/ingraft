...
| User intent                                     | Command                                                   |
| ----------------------------------------------- | --------------------------------------------------------- |
| "auto vendor dependencies", "scan dependencies" | `bunx ingraft@latest` or `bunx ingraft@latest deps`       |
...
- Running `ingraft` with no subcommand scans project package manifests, matches npm packages to source repos, and asks which ones to vendor or update.
