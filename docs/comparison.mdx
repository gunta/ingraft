...
**Best for**: Teams that want the repository to become the context contract for agents. Use the vendoring routes for deep, version-matched source context; use the context wrappers for lighter packs, lazy source lookup, and search.
