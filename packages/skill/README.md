...
The skill intentionally contains no repository-context implementation. It delegates to the published CLI with `bunx ingraft`, so agents get the current standalone tool without copying TypeScript source into every skill install.
